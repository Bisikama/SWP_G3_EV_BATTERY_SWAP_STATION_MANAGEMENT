...
const { sendPasswordResetEmail, sendPasswordChangeConfirmation, generateVerificationCode, sendVerificationEmail } = require('../utils/emailService');
...
module.exports = { findAll, login, register, logout, requestPasswordReset, resetPassword, findById, findByEmail, requestEmailVerification, verifyEmailCode };
