...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const vehicleModels = [
      { battery_type_id: byCode['NMC-50'], name: 'Ludo', brand: 'VinFast', avg_energy_usage: 2.10, battery_slot: 2 },
      { battery_type_id: byCode['NMC-50'], name: 'Impes', brand: 'VinFast', avg_energy_usage: 2.20, battery_slot: 2 },
      ...
      { battery_type_id: byCode['NMC-50'], name: 'Evo200', brand: 'VinFast', avg_energy_usage: 2.30, battery_slot: 1 }
    ];
