...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    // District 1 Central Station: 3 cabinets (10 slots each)
    for (let i = 1; i <= 3; i++) {
      cabinets.push({
    ...
    // District 3 Tech Hub: 2 cabinets (10 slots each)
    for (let i = 1; i <= 2; i++) {
      cabinets.push({
    ...
    // Binh Thanh Station: 2 cabinets (10 slots each)
    for (let i = 1; i <= 2; i++) {
      cabinets.push({
    ...
    // Thu Duc Service Center: 2 cabinets (10 slots each)
    for (let i = 1; i <= 2; i++) {
      cabinets.push({
    ...
    // Tan Binh Airport Station: 1 cabinet (10 slots, maintenance)
    cabinets.push({
